...
After downloading `PRSPGx` package, unzip it and you will see `PRSPGx_0.2.0.tar.gz`. To install `PRSPGx`, type the following code from an `R` session:

```
install.package("PRSPGx_0.2.0.tar.gz", repos = NULL)
library(PRSPGx)
```
